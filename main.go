...
func main() {
	...
	svc.Register(translator.NewYodaTranslator(httpClient, cfg.YodaTranslatorURL))
	svc.Register(translator.NewShakespeareTranslator(httpClient, cfg.ShakespeareTranslatorURL))
